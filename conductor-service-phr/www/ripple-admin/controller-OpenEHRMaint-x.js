...
module.exports = function (controller, component) {
  ...
  component.deleteHeading = function() {
    ...
    console.log('patientId: ' + component.patientId2);
    console.log('heading: ' + component.heading2);

    if (typeof component.patientId2 !== 'string' || component.patientId2 === '') {
      controller.displayError('You must enter a patient Id');
      return;
    }

    if (typeof component.heading2 !== 'string' || component.heading2 === '') {
      controller.displayError('You must enter a Heading');
      return;
    }
    ...
    controller.send({
      type: 'deleteHeading',
      params: {
        patientId: component.patientId2,
        heading: component.heading2,
